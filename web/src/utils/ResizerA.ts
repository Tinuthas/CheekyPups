class Resizer {
  ...
  static imageFileResizer = (file:any, maxWidth:any, maxHeight:any, compressFormat:any, quality:any, rotation:any, responseUriFunc:any, outputType:any, minWidth:any, minHeight:any) => { return Resizer.createResizedImage( file, maxWidth, maxHeight, compressFormat, quality, rotation, responseUriFunc, outputType, minWidth, minHeight, ); }
}
  


const resizeFile = (file:any) => new Promise((resolve) => { Resizer.imageFileResizer(file, 300, 300, "png", 100, 0, (uri: any) => { resolve(uri) }, "file", null, null); });
