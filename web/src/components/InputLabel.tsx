...
export const InputLabel = ({labelName, value, type, placeholder, onChange}: InputLabelProps) => {
  return (
    <div className="mb-1 md:flex md:flex-row md:items-center xl:justify-between">
      ...
      <input
        ...
        className="block w-full px-4 py-2 mt-1 md:ml-6 text-neutral-600 bg-white border-[1px] border-neutral-700 rounded"
      />
    </div>
  )
}